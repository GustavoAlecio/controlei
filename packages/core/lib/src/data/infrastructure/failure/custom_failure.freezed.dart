...
class _$AppFailureImpl implements AppFailure {
  const _$AppFailureImpl({required this.message, this.stackTrace});
  ...
  @override
  String toString() {
    return 'Failure.app(message: $message, stackTrace: $stackTrace)';
  }
...
abstract class AppFailure implements Failure {
  const factory AppFailure(
      ...
      final StackTrace? stackTrace}) = _$AppFailureImpl;
...
class _$NetworkFailureImpl implements NetworkFailure {
  const _$NetworkFailureImpl({required this.message, this.stackTrace});
...
class _$UnknownFailureImpl implements UnknownFailure {
  const _$UnknownFailureImpl({required this.message, this.stackTrace});
