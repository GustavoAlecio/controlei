...
abstract class $AccountStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Account> accounts, List<String> categories});
}
...
class _$AccountStateImpl extends _AccountState {
  ...
  @override
  String toString() {
    return 'AccountState(accounts: $accounts, categories: $categories)';
  }
...
abstract class _AccountState extends AccountState {
  const factory _AccountState(
      ...
      final List<String> categories}) = _$AccountStateImpl;
